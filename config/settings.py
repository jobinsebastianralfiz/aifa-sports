"""
Django settings for AIFA Sports Academy project.
"""
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.core.context_processors.page_content',
...
# to avoid missing file hash errors
...
LOGIN_REDIRECT_URL = 'admin_dashboard:index'
...
# DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@aifasports.com')
